/*
    zdiscord - by - Manshy - License: CC BY-NC-SA 4.0
    Docs for this file available at or in
*/
 ...
 ********************************/
 ...
 const LanguageLocaleCode = "ar";

 // PUBLIC VALUES
 const FiveMServerName = "QB Test";
 const DiscordInviteLink = "https://discord.gg/RmJXfQKQ4j";
 ...
 // DISCORD BOT
 const DiscordBotToken = "MTAxNTM5OTE4OTM5NzY1MTUwNg.GK9GTN.Al_pvhelTqNEAiLDVPkK5s2Uk5qpTV1Negm8ZA";
 const DiscordGuildId = "996850348364939335";
 
 // STAFF CHAT
 const EnableStaffChatForwarding = false;
 const DiscordStaffChannelId = "1013866316354039858";
 ...
 const DiscordWhitelistRoleIds = "1015483155362369586";
 
 // SLASH COMMANDS / DISCORD PERMISSIONS
 const EnableDiscordSlashCommands = true;
 const DiscordModRoleId = "1015483795627048990";
 const DiscordAdminRoleId = "1015483795627048990";
 const DiscordGodRoleId = "1015483795627048990";
